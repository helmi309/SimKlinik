        ...
        <div class="page-inner">
          <div class="page-header">
            ...
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('/pembayaran')); ?>">pembayaran</a>
              </li>
              <li class="separator">
                <i class="flaticon-right-arrow"></i>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/pembayaran_detil')); ?>"><?php echo e($subtitle); ?></a>
                    ...
                    <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td><?php echo e($k->registrasi1->no_registrasi); ?></td>
                            <td><?php echo e($k->registrasi1->pasien->nama); ?></td>
                            <td><?php echo e($k->registrasi1->dokter->nama_dokter); ?></td>
                            <td><?php echo e($k->registrasi1->poli->nama_poli); ?></td>
                            <!-- <td><?php echo e(hitung_usia($k->tgl_lahir)); ?></td> -->
                            <td><?php echo e(tgl_indo($k->registrasi1->tgl_reg)); ?></td>
                            <td>
                             <a href="<?php echo e(url('/pembayaran_detil/'.$id.'/edit')); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Kerja\klinik-master\klinik-master\resources\views/pembayaran/pembayaran_detil/index.blade.php ENDPATH**/ ?>