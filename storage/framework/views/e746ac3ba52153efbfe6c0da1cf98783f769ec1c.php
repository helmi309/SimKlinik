                ...
                <form id="CreateDataTransaksi" method="POST" enctype="multipart/form-data" onsubmit="return false">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="pembayaran_id" value="<?php echo e($idx); ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                <label>Qty</label>
                                <input name="qty" type="text" class="form-control" onkeypress='validate(event)'
                                       placeholder="Qty">
                            </div>
                        </div>
        ...
        $("#SubmitCreateTransaksi").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#reloadpaginate').html('');
                    $('#reloadpaginate').load("/pembayaran_detil/"+'<?php echo Crypt::encrypt($idx); ?>'+"/edit");
                },
                error: function (data) {
...
</script><?php /**PATH E:\Kerja\klinik-master\klinik-master\resources\views/pembayaran/pembayaran_detil/add_transaksi.blade.php ENDPATH**/ ?>